...
var _createClass = function() {
    function f(g, j) {
        for (var l, k = 0; k < j.length; k++) l = j[k], l.enumerable = l.enumerable || !1, l.configurable = !0, "value" in l && (l.writable = !0), Object.defineProperty(g, l.key, l)
    }
...
var Pageable = function() {
    function f(g, j) {
        var k = this;
        if (_classCallCheck(this, f), void 0 === g) return console.error("Pageable:", "No container defined.");
    ...
    return _createClass(f, [{
        ...
        value: function() {
            var j = location.hash;
            if (j) {
                var k = this.anchors.indexOf(j); - 1 < k && (this.index = k, this.setPips(), this.wrapper[this.scrollAxis[this.axis]] = (this.horizontal ? window.innerWidth : window.innerHeight) * this.index, this.config.onFinish.call(this, {
